package com.skysam.datossegurosFirebaseFinal.ui.nota;
...
public class EditarTarjetaFragment extends Fragment {
        ...
        reference.document(idDoc).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()) {
                    ...
                    etTarjeta.setText(doc.getString(Constantes.BD_NUMERO_TARJETA));
    ...
    public void guardarDataFirebase(String titular, String banco, String numeroTarjeta, String cvv, String vencimiento, String cedula, String clave) {
        ...
        db.collection(Constantes.BD_PROPIETARIOS).document(userID).collection(Constantes.BD_TARJETAS).document(idDoc).update(tarjeta).addOnSuccessListener(new OnSuccessListener<Void>() {
