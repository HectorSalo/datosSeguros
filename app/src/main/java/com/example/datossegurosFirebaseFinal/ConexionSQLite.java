...
public class ConexionSQLite extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE cuentas (idCuenta integer primary key autoincrement, titularbanco text, banco text, numerocuenta text, cedulabanco text, tipocuenta text, telefono text, correocuenta text, tipodocumentobanco text)");
        db.execSQL("CREATE TABLE tarjetas (idTarjeta integer primary key autoincrement, titulartarjeta text, numerotarjeta text, cvv text, cedulatarjeta text, tipotarjeta text, bancotarjeta text, vencimientotarjeta text, clavetarjeta text)");
