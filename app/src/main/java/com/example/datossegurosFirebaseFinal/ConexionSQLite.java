...
public class ConexionSQLite extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE contrasenas (idContrasena integer primary key autoincrement, servicio text, usuario text, password text, vigencia text, passviejo1 text, passviejo2 text, passviejo3 text, passviejo4 text, passviejo5 text, fechacreacion date)");
